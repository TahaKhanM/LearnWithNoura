...
Date: 2026-08-23; updated 2026-08-26 for the Phase 1 voice-transport overhaul, Phase 3a Board Director, and Phase 3b renderer vocabulary + spatial camera regions. Status: active, with a full-product public-v0 boundary and explicit real-user Production blockers.
